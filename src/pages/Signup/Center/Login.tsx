      ...
      return (
        <div className="h-full flex flex-col items-center font-pre select-none p-[20px]">
          ...
          <div className="w-full h-full flex flex-col justify-center items-center p-[20px]">
            <object
              className="w-[190px]"
              data="/assets/icons/logo-full.svg"
              type="image/svg+xml"
            >
            ...
            <Space css="h-[100px]" />
            <button
              className="w-full h-[48px] flex justify-center items-center bg-[#FF8411] rounded-full text-[16px] text-[#FFFFFF] font-extrabold"
            ...
            <div className="flex justify-center">
              <button
                className="text-[13px] text-[#717171] underline underline-offset-2 text-center font-medium"
                onClick={() => setStep(1)}
              >
                이미 가입한 적이 있어요
              </button>
        ...
        <div className="h-full flex flex-col items-center font-pre select-none p-[20px]">
          ...
          <div className="flex flex-col w-full h-full">
            ...
            <div className="flex justify-center">
              <object
                className="w-[140px]"
                data="/assets/icons/logo-login.svg"
                type="image/svg+xml"
              >
