    ...
    <>
      <Routes>
        ...
        <Route element={<PrivateRoute />}>
          <Route
            path="/"
            element={getUserType() === 1 ? <CareHome /> : <Home />}
          />
          <Route
            path="/jobs/add"
            element={
          ...
          />
          <Route
            path="/seniors/:seniorId/jobs/add"
            element={
              getUserType() === 1 ? <Navigate replace to="/" /> : <AddJob />
            }
          />
          <Route
            path="/jobs/:jobId"
            element={getUserType() === 1 ? <CareJobDetail /> : <JobDetail />}
          />
          <Route
            path="/jobs/:jobId/recommend"
            element={
              getUserType() === 1 ? <Navigate replace to="/" /> : <Recommend />
            }
          />
          <Route
            path="/resume"
          ...
          <Route
            path="/seniors/add"
            element={
              getUserType() === 1 ? <Navigate replace to="/" /> : <AddSenior />
            }
          />
          <Route
            path="/chats"
            element={getUserType() === 1 ? <CareChatList /> : <ChatList />}
          />
          <Route
            path="/chats/detail"
            element={getUserType() === 1 ? <CareChat /> : <Chat />}
          />
          <Route
            path="/mypage"
            element={getUserType() === 1 ? <CareMyPage /> : <MyPage />}
          />
          <Route
            path="/menu"
            element={getUserType() === 1 ? <CareMenu /> : <Menu />}
          />
        </Route>
      </Routes>
    </>
